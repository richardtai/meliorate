...
CPPPATH_PG = ['/usr/local/Cellar/postgresql/9.2.3/include']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/richardtai/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_PG = ['/usr/local/Cellar/postgresql/9.2.3/lib']
LIBPATH_ST = '-L%s'
LIB_PG = ['pq']
LIB_ST = '-l%s'
LINKFLAGS = ['-arch', 'i386']
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/richardtai/.node_libraries'
